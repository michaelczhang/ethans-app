...
export const STARCRAFT_QUESTIONS: QuizQuestion[] = [
  {
    id: "sc-1",
    question: "What is the base attack cooldown (in seconds) of a Terran Marine in StarCraft II with no Stimpack?",
    options: ["0.61", "0.72", "0.86", "1.00"],
    correctIndex: 2,
  },
  {
    id: "sc-2",
    question: "How many missions are in the main Wings of Liberty campaign (excluding the epilogue)?",
    options: ["25", "26", "29", "32"],
    correctIndex: 2,
  },
  {
    id: "sc-3",
    question: "What is the base HP of a Zergling in StarCraft II?",
    options: ["25", "35", "45", "50"],
    correctIndex: 1,
  },
  {
    id: "sc-4",
    question: "What is the attack range of a StarCraft II Siege Tank while in Siege Mode?",
    options: ["10", "12", "13", "15"],
    correctIndex: 2,
  },
  {
    id: "sc-5",
    question: "Which StarCraft: Brood War ability deals the most single-hit damage?",
    options: ["Psionic Storm", "Yamato Gun", "Nuclear Strike", "Siege Tank shell"],
    correctIndex: 2,
  },
  {
    id: "sc-6",
    question: "Who won the first BlizzCon StarCraft II World Championship in 2011?",
    options: ["MC", "MMA", "DRG", "Nestea"],
    correctIndex: 1,
  },
  {
    id: "sc-7",
    question: "What is the base HP of an Ultralisk in Legacy of the Void (no Chitinous Plating)?",
    options: ["400", "500", "600", "700"],
    correctIndex: 1,
  },
  {
    id: "sc-8",
    question: "Which StarCraft II Zerg spellcaster uses the Abduct ability to pull enemies toward it?",
    options: ["Infestor", "Queen", "Viper", "Overseer"],
    correctIndex: 2,
  },
  {
    id: "sc-9",
    question: "Which SC2 Co-op Commander was released FIRST as premium DLC (after the base roster)?",
    options: ["Alarak", "Fenix", "Nova", "Han and Horner"],
    correctIndex: 2,
  },
  {
    id: "sc-10",
    question: "Who leads the Nerazim (Dark Templar) after Matriarch Raszagal's death?",
    options: ["Zeratul", "Matriarch Vorazun", "Selendis", "Karax"],
    correctIndex: 1,
  },
  {
    id: "sc-11",
    question: "Who voices Tychus Findlay in StarCraft II?",
    options: ["Robert Clotworthy", "James Harper", "Neal McDonough", "Fred Tatasciore"],
    correctIndex: 2,
  },
  {
    id: "sc-12",
    question: "Which StarCraft II Co-op Commander deploys the Odin as their signature hero unit?",
    options: ["Nova", "Swann", "Han and Horner", "Raynor"],
    correctIndex: 1,
  },
  {
    id: "sc-13",
    question: "In the StarCraft timeline, what in-universe year does Legacy of the Void take place?",
    options: ["2504", "2505", "2506", "2510"],
    correctIndex: 2,
  },
  {
    id: "sc-14",
    question: "Which Terran scientist joins Raynor's Raiders in Wings of Liberty to research a Zerg cure?",
    options: ["Ariel Hanson", "Egon Stetmann", "Rory Swann", "Emil Narud"],
    correctIndex: 0,
  },
  {
    id: "sc-15",
    question: "In StarCraft: Brood War, how long does a Ghost's Lockdown last on a mechanical target?",
    options: ["30 seconds", "60 seconds", "90 seconds", "Indefinite"],
    correctIndex: 1,
  },
  {
    id: "sc-16",
    question: "Which StarCraft II Protoss unit has the Hardened Shield passive?",
    options: ["Colossus", "Stalker", "Immortal", "Sentry"],
    correctIndex: 2,
  },
  {
    id: "sc-17",
    question: "Which Zerg unit's ability to spawn Infested Terrans was removed in Legacy of the Void?",
    options: ["Queen", "Infestor", "Nydus Worm", "Swarm Host"],
    correctIndex: 1,
  },
  {
    id: "sc-18",
    question: "What is the standard maximum supply cap for a single player in StarCraft II?",
    options: ["150", "175", "200", "250"],
    correctIndex: 2,
  },
  {
    id: "sc-19",
    question: "Which Protoss faction is led by First Ascendant Alarak in Legacy of the Void?",
    options: ["Nerazim", "Daelaam", "Tal'darim", "Khalai"],
    correctIndex: 2,
  },
  {
    id: "sc-20",
    question: "What is the name of Sarah Kerrigan's Zerg flagship class in Heart of the Swarm?",
    options: ["Leviathan", "Behemoth", "Char Prime", "Overseer"],
    correctIndex: 0,
  },
  {
    id: "sc-21",
    question: "Which Protoss hero was killed by Kerrigan on Aiur during the Brood War Zerg campaign?",
    options: ["Tassadar", "Fenix", "Zeratul", "Artanis"],
    correctIndex: 1,
  },
  {
    id: "sc-22",
    question: "Which StarCraft II Protoss unit gains air attack range from the Anion Pulse-Crystals upgrade?",
    options: ["Phoenix", "Void Ray", "Corsair", "Tempest"],
    correctIndex: 0,
  },
  {
    id: "sc-23",
    question: "Which Legacy of the Void Protoss faction is made of ancient consciousnesses in robotic bodies?",
    options: ["Nerazim", "Tal'darim", "Purifiers", "Khalai"],
    correctIndex: 2,
  },
  {
    id: "sc-24",
    question: "What is the name of the Xel'Naga artifact used to de-infest Sarah Kerrigan?",
    options: ["Uraj Crystal", "Khalis Crystal", "Keystone", "Argus Stone"],
    correctIndex: 2,
  },
  {
    id: "sc-25",
    question: "Which SC2 Co-op Commander uses the Spear of Adun to activate calldown abilities?",
    options: ["Karax", "Artanis", "Vorazun", "Alarak"],
    correctIndex: 0,
  },
];
